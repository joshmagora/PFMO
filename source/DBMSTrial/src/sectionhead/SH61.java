 ...
 * @author Josh
 */
public class SH61 extends javax.swing.JFrame {
...
String username = null;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Borrowing Slip");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(167, 167, 167)
                .addComponent(btn_submit, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        if (response == JOptionPane.YES_OPTION){
            try{
                Boolean success = false;
                    ...
                    String str3 = "insert into pfmo.bslip "
                            + "(bslip_date, emp_no, status_code) values "
                            + "('"+b+"', "
                            + "'"+d+"','P');";
                    ps = conn.prepareStatement(str3);
                    ps.execute();
                    String str4 = "select bslip_no from pfmo.bslip "
                            + "where bslip_date = '"+b+"' ";
                    ps = conn.prepareStatement(str4);
                    rs = ps.executeQuery();
                    if(rs.next()) c = rs.getString("bslip_no");
            for(int i = 0; i<Integer.parseInt(txt_numTools.getText()); i++){
            if(i == 0){
                    String str2 = "select t_code from pfmo.tool"
                        + " where t_desc = '"+cmb_description1.getSelectedItem().toString()+"'"
                        + " and t_type = '"+cmb_type1.getSelectedItem().toString()+"'; ";
                    ps = conn.prepareStatement(str2);
                    rs = ps.executeQuery();
                    if(rs.next()) type = rs.getString("t_code");
                    String st3 = "select Available from pfmo.tool_inventory "
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()) count = rs.getString("Available");
                    if((Integer.parseInt(count))>=(Integer.parseInt(txt_quantity1.getText().toString()))){
                        success = true;
                    String str1 = "insert into pfmo.bslip_details "
                            + "(bslip_no,t_code,quantity) "
                            + "values ("
                    ...
                    ps.execute();}
                     ...
                     String str2 = "select t_code from pfmo.tool"
                        + " where t_desc = '"+cmb_description2.getSelectedItem().toString()+"'"
                        + " and t_type = '"+cmb_type2.getSelectedItem().toString()+"'; ";
                    ps = conn.prepareStatement(str2);
                    rs = ps.executeQuery();
                    if(rs.next()) type = rs.getString("t_code");
                    String st3 = "select Available from pfmo.tool_inventory "
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()) count = rs.getString("Available");
                    if(Integer.parseInt(count)>=Integer.parseInt(txt_quantity2.getText())){
                        success = true;
                    String str1 = "insert into pfmo.bslip_details "
                            + "(bslip_no,t_code,quantity) "
                            + "values ("
                 ...
                 String str2 = "select t_code from pfmo.tool"
                        + " where t_desc = '"+cmb_description3.getSelectedItem().toString()+"'"
                        + " and t_type = '"+cmb_type3.getSelectedItem().toString()+"'; ";
                    ps = conn.prepareStatement(str2);
                    rs = ps.executeQuery();
                    if(rs.next()) type = rs.getString("t_code");
                    String st3 = "select Available from pfmo.tool_inventory "
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()) count = rs.getString("Available");
                    if(Integer.parseInt(count)>=Integer.parseInt(txt_quantity3.getText())) {
                        success = true;
                    String str1 = "insert into pfmo.bslip_details "
                            + "(bslip_no,t_code,quantity) "
                            + "values ("
                 ...
                 String str2 = "select t_code from pfmo.tool"
                        + " where t_desc = '"+cmb_description4.getSelectedItem().toString()+"'"
                        + " and t_type = '"+cmb_type4.getSelectedItem().toString()+"'; ";
                    ps = conn.prepareStatement(str2);
                    rs = ps.executeQuery();
                    if(rs.next()) type = rs.getString("t_code");
                    String st3 = "select Available from pfmo.tool_inventory "
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()) count = rs.getString("Available");
                    if(Integer.parseInt(count)>=Integer.parseInt(txt_quantity4.getText())) {
                        success = true;
                    String str1 = "insert into pfmo.bslip_details "
                            + "(bslip_no,t_code,quantity) "
                            + "values ("
                 ...
                 String str2 = "select t_code from pfmo.tool"
                        + " where t_desc = '"+cmb_description5.getSelectedItem().toString()+"'"
                        + " and t_type = '"+cmb_type5.getSelectedItem().toString()+"'; ";
                    ps = conn.prepareStatement(str2);
                    rs = ps.executeQuery();
                    if(rs.next()) type = rs.getString("t_code");
                    String st3 = "select Available from pfmo.tool_inventory "
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()) count = rs.getString("Available");
                    if(Integer.parseInt(count)>=Integer.parseInt(txt_quantity5.getText())) {
                        success = true;
                    String str1 = "insert into pfmo.bslip_details "
                            + "(bslip_no,t_code,quantity) "
                            + "values ("
            ...
            if(success == true) JOptionPane.showMessageDialog(null,"Success");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try{
            ...
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_type1.addItem(rs.getString("t_type"));
                cmb_type2.addItem(rs.getString("t_type"));
                cmb_type3.addItem(rs.getString("t_type"));
                cmb_type4.addItem(rs.getString("t_type"));
                cmb_type5.addItem(rs.getString("t_type"));
            } 
        } catch (Exception e){
    ...
    private void cmb_description1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_description1MouseClicked
        ...
        try{
            ...
            String str3 = "select t_desc  from pfmo.tool"
                    + " where t_type = '"+cmb_type1.getSelectedItem()+"'; ";
            ps = conn.prepareStatement(str3);
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_description1.addItem(rs.getString("t_desc"));
            } 
        }
        catch (Exception e) {
             JOptionPane.showMessageDialog(null,e);
    ...
    private void cmb_description2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_description2MouseClicked
        ...
        try{
            conn = ConnectTESTING.Connect();
            String str3 = "select t_desc  from pfmo.tool"
                    + " where t_type = '"+cmb_type2.getSelectedItem()+"'; ";
            ps = conn.prepareStatement(str3);
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_description2.addItem(rs.getString("t_desc"));
            } 
        }
        catch (Exception e) {
             JOptionPane.showMessageDialog(null,e);
    ...
    private void cmb_description3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_description3MouseClicked
        ...
        try{
            conn = ConnectTESTING.Connect();
            String str3 = "select t_desc  from pfmo.tool"
                    + " where t_type = '"+cmb_type3.getSelectedItem()+"'; ";
            ps = conn.prepareStatement(str3);
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_description3.addItem(rs.getString("t_desc"));
            } 
        }
        catch (Exception e) {
             JOptionPane.showMessageDialog(null,e);
    ...
    private void cmb_description4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_description4MouseClicked
        ...
        try{
            conn = ConnectTESTING.Connect();
            String str3 = "select t_desc  from pfmo.tool"
                    + " where t_type = '"+cmb_type4.getSelectedItem()+"'; ";
            ps = conn.prepareStatement(str3);
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_description4.addItem(rs.getString("t_desc"));
            } 
        }
        catch (Exception e) {
             JOptionPane.showMessageDialog(null,e);
    ...
    private void cmb_description5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_description5MouseClicked
        ...
        try{
            conn = ConnectTESTING.Connect();
            String str3 = "select t_desc  from pfmo.tool"
                    + " where t_type = '"+cmb_type5.getSelectedItem()+"'; ";
            ps = conn.prepareStatement(str3);
            rs = ps.executeQuery();
            while(rs.next()){
                cmb_description5.addItem(rs.getString("t_desc"));
            } 
        }
        catch (Exception e) {
             JOptionPane.showMessageDialog(null,e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SH61.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
